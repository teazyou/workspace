...
# running the /caveman-compress slash command; the session TUI streams live in
# the terminal, then the script kills it and prints its <result> summary.
# Lives at scripts/claude/caveman_compress.sh.
